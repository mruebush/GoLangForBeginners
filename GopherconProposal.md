...
[Could this outline help or be too much?](GopherConWorkshop.md)

**Ideal Student**: This workshop is for individuals with little to no programming experience! Attendees do not need to have studied Computer Science, be familiar with another programming language, or even be completely sure what programming is all about. 
...
We would also be interested to help offer some diversity scholarships for GopherCon as part of Capital One for people that are interested in learning Go and also attending this workshop from communities that would not have the opportunities to attend GopherCon or a workshop like this. We would also like to provide a "recommended" curriculum for GopherCon for topics that would be good for those that are new to programming and Go. We would really like to see this curriculum be available to the community and anyone to be able to learn from.
